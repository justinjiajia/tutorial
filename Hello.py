...
create_charts = st.Page("charts/create_charts.py", title="🎯Practice: Create charts")
...
advanced_todo_list = st.Page("widgets/advanced_todo_list.py", title="🎯Practice: Advanced to-do list")
